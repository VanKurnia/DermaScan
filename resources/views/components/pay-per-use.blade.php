<x-layout-menu>
    <main class="p-4 md:ml-64 h-full pt-20">
        <div class="border-2 border-dashed rounded-lg border-gray-300 dark:border-gray-600 h-full mb-4">
                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                        ...
                        <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at Flowbite we focus
                            on
                            markets where technology, innovation, and capital can unlock long-term value and drive
                            economic
                            growth.</p>
                    </div>
                ...
                .then(data => {
                    if (data.snap_token) {
                        window.snap.pay(data.snap_token, {
                            ...
                            onClose: function() {
                                /* You may want to give a reminder to the user to complete their payment. */
