<div>
    <aside
            ...
            <ul class="pt-5 mt-5 space-y-2 border-t border-gray-200 dark:border-gray-700">
                <li>
                    <button type="button"
                        ...
                        <svg aria-hidden="true"
                            class="flex-shrink-0 w-6 h-6 text-sky-500 transition duration-75 group-hover:text-blue-600 dark:text-sky-500 dark:group-hover:text-blue-600"
                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                            <path
                        ...
                        <span class="flex-1 ml-3 text-left whitespace-nowrap">DermaScan Pro</span>
                    ...
                    <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                        <li>
                            <a href="/pay-per-use"
                                ...
                                <span class="ml-3">Pay-per-use</span>
                            </a>
                        </li>
                        <li>
                            <a href="/subscription"
        ...
        <div
            ...
            <a href="#" class="text-slate-400 text-sm">
                © Copyright 2025 - Ivan Kurniawan
            </a>
        </div>
    </aside>
</div>
