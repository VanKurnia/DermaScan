                ...
                <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                    ...
                    <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                        ...
                        <div
                            ...
                            <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400 flex-1">
                            ...
                            <button id="pay-button-1b"
                                class="mt-auto text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:ring-primary-200 font-semibold rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-primary-900">
                                Beli
                            </button>
                        </div>
                        ...
                        <div
                            ...
                            <p class="font-light text-sm text-gray-500 sm:text-lg dark:text-gray-400 flex-1">
