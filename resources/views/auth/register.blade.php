<x-layout>
    <section class="bg-gray-50 dark:bg-gray-900">
        <div class="flex flex-col items-center justify-center px-6 py-8 my-8 mx-auto h-fit min-h-screen lg:py-0">
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="{{ route('register') }}" method="POST">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" placeholder="Tuliskan nama anda..."
                                required=""
                        ...
                        <div>
                            ...
                            @error('email')
                                ...
                                if ($message === 'The email has already been taken.') {
                                    $alert = 'Email yang anda isikan sudah digunakan';
                                }
                                ?>
                                <span class="text-sm text-red-500 mt-1" role="alert">
                                    <strong>{{ $message }}</strong>
                        ...
                        <button type="submit"
                            class="w-full text-base text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-semibold rounded-lg px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">
                            Register
                        </button>
